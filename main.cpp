...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "CapricoinPlus-seeder\n"
...
static const string mainnet_seeds[] = {"maindns1.capricoin.org",
                                       "maindns2.capricoin.org",
                                       "maindns3.capricoin.org",
                                       "maindns4.capricoin.org",
                                       ""};
static const string testnet_seeds[] = {"testdns1.capricoin.org",
                                       "testdns2.capricoin.org"
                                       "testdns3.capricoin.org"
                                       "testdns4.capricoin.org"
                                       ""};
...
extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("198.211.123.100", 11111), true);
    db.Add(CService("198.211.123.241", 11111), true);
    db.Add(CService("45.77.185.219", 11111), true);
    db.Add(CService("95.179.169.144", 11111), true);
    db.Add(CService("149.28.212.189", 11111), true);
    db.Add(CService("80.240.24.4", 11111), true);
    db.Add(CService("198.13.57.17", 11111), true);
  }
  do {
